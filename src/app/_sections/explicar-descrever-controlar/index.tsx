export default function ExplicarDescreverControlarSection() {
  return (
    <section className="relative top-[-13px] bg-transparent">
      <div
      ...
      >
        <div className="max-w-8xl mx-auto flex h-full flex-col items-center justify-start px-7 py-9 sm:px-6 md:px-8 md:py-16">
          <div className="">
            <p className="mb-32 text-center font-space-grotesk text-xs uppercase tracking-[.2em] text-black">
              Explicar - Descrever - Controlar
            </p>
            <h2 className="mb-32 h-56 text-center font-utopia-std text-4xl font-semibold tracking-[-0.075em] text-black md:mb-20 md:w-[925px] md:text-6xl">
              “Aqui a ideia é ter uma mensagem de impacto que relacionada ao
              propósito ou transformacão que a contextual gera.”
            </h2>
