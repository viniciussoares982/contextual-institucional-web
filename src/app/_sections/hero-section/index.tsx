      ...
      <div className="h-[740px] bg-[url('/background_hero_contextual4.png')] bg-cover bg-center">
        <div className="max-w-8xl mx-auto flex h-full flex-col items-center justify-end px-7 py-28 sm:px-6 md:px-8">
          ...
          <div className="mt-6">
            <a
              href="/"
              className="mb-4 flex h-8 w-52 items-center justify-center rounded-md border border-black bg-contextual-pink text-center font-space-grotesk text-xs uppercase tracking-[.2em] text-black"
            >
              Entre na Comunidade
            </a>
            <a
              href="#conteudos"
              className="flex h-8 w-52 items-center justify-center rounded-md border border-black bg-transparent text-center font-space-grotesk text-xs uppercase tracking-[.2em] text-black"
            >
              Explorar Conteúdos
            </a>
          </div>
